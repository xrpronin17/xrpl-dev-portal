...
- [Require Auth](authorized-trust-lines.html#enabling-require-auth) so that users can't open [trust lines](fungible-tokens.html) to you without your permission. If you don't plan to use the XRP Ledger's decentralized exchange or [token](tokens.html) features, you may want to do this as a precaution.
