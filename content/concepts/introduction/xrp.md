...
In technical contexts, XRP is measured precisely to the nearest 0.000001 XRP, called a "drop" of XRP. The [<span class="code-snippet">rippled</span> APIs](http-websocket-apis.html) require all XRP amounts to be specified in drops of XRP. For example, 1 XRP is represented as <span class="code-snippet">1000000</span> drops. For more detailed information, see the [currency format reference](currency-formats.html).
