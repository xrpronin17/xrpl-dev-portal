...
**Current Transaction Cost in Drops = (<span class="code-snippet">base_fee</span> × <span class="code-snippet">load_factor</span>) ÷ <span class="code-snippet">load_base</span>**
