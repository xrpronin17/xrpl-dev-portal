...
This section describes data types and formats of the HTTP APIs (JSON-RPC and WebSocket) as implemented in [the <span class="code-snippet">rippled</span> server](xrpl-servers.html).
